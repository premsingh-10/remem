...
const VisionMission = () => {
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center">
      ...
      <div className="mb-6">
          <img src="/"
           alt="Enterprise Vision" className="w-full h-auto rounded-md" />
        </div>
        <h1 className="text-3xl font-bold mb-4">Our Enterprise Vision</h1>
        <p className="text-gray-700 mb-6">
          At XYZ Enterprises, our vision is to empower businesses with cutting-edge technologies and innovative solutions.
